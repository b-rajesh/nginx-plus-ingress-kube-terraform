...
tag_1_node_pool        = "created-by-"             //some meaningful tags
tag_2_node_pool        = "gke-node-pool-for-nginx-plus-ingress" //some meaningful tags
unique_user_id         = "<your-unique-user-id>"                         //your username would be unique
...
# common variables
environment = "<your-environemnt-name>"
# nginx plus ingress controller variables
name_of_ingress_container = "nginx-plus-ingress-container-1-7-2"
...
prefix                            = "xxx" //keep it within 3-5 letters as the code is also generating unique petname along with it.
...
ingress_conroller_version     = "1.7.2"
# Azure AKS
